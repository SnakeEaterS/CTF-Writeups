...
### 1. Loging into the SSH Shell and checking the directory
...
Wanting to know what the script does I did "man useless" to check the documentation if it has any before reading the script itself. Within the documentation the script seems to be a simple calculator scipt that handles addiditon, multiplication, subtraction and division.
